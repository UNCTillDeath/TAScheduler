...
public class JFXDecorator extends VBox {
    ...
    public JFXDecorator(Stage stage, Node node, boolean fullScreen, boolean max, boolean min) {
        ...
        buttonsContainer.setMargin(btnClose, new Insets(0,0,0,10));
        ...
        titlewrap.getStyleClass().add("titlelabel");
        titlewrap.setAlignment(Pos.CENTER_RIGHT);
        titlewrap.setPadding(new Insets(4));
        ...
        titlewrap.getChildren().add(title);
        titlewrap.setMargin(title, new Insets(0,144,0,0));
        
        wrap.setCenter(titlewrap);
        wrap.setRight(buttonsContainer);
        ...
        node.setClip(clip);
        this.getChildren().addAll(wrap, contentPlaceHolder);
